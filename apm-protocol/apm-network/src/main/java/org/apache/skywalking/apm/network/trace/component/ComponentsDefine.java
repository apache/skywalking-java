...
public class ComponentsDefine {
    ...
    public static final OfficialComponent APACHE_KYLIN_JDBC_DRIVER = new OfficialComponent(121,
    ...
    public static final OfficialComponent JERSEY = new OfficialComponent(134, "Jersey");

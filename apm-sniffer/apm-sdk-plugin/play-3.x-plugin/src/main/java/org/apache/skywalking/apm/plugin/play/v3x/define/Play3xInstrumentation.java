...
package org.apache.skywalking.apm.plugin.play.v3x.define;
...
public class Play3xInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    private static final String ENHANCE_CLASS = "play.api.http.EnabledFilters";
    private static final String ENHANCE_METHOD = "filters";
    private static final String INTERCEPTOR_CLASS = "org.apache.skywalking.apm.plugin.play.v3x.HttpFiltersInterceptor";
        ...
        return new ConstructorInterceptPoint[] {
            new ConstructorInterceptPoint() {
                ...
                public ElementMatcher<MethodDescription> getConstructorMatcher() {
                    return Play3xInstrumentation.getInjectConstructorMatcher();
                }
        ...
        return new InstanceMethodsInterceptPoint[] {
            new InstanceMethodsInterceptPoint() {
                ...
                public ElementMatcher<MethodDescription> getMethodsMatcher() {
                    return Play3xInstrumentation.getFiltersMethodMatcher();
                }

...
package org.apache.skywalking.apm.plugin.play.v3x;

import net.bytebuddy.description.method.MethodDescription;
import net.bytebuddy.matcher.ElementMatcher;
import org.apache.skywalking.apm.plugin.play.v3x.define.Play3xInstrumentation;
import org.junit.Assert;
import org.junit.Test;
import play.api.http.EnabledFilters;

public class Play3xInstrumentationTest {

    @Test
    public void testConstructorMatch() throws Exception {
        final ElementMatcher<MethodDescription> matcher = Play3xInstrumentation.getInjectConstructorMatcher();
    ...
    public void testMethodMatch() throws Exception {
        final ElementMatcher<MethodDescription> matcher = Play3xInstrumentation.getFiltersMethodMatcher();

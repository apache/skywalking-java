...
/**
 * Message properties injector implementation for pulsar client version 2.8.x
 */
public class MessagePropertiesInjectorV28 implements MessagePropertiesInjector {
    ...
    public void inject(MessageImpl<?> message, CarrierItem carrierItem) {
        final KeyValue keyValue = message.getMessageBuilder().addProperty();
        keyValue.setKey(carrierItem.getHeadKey());
        keyValue.setValue(carrierItem.getHeadValue());
    }
}

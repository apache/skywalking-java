...
public class ProducerImplAsyncInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String INTERCEPTOR_CLASS = "org.apache.skywalking.apm.plugin.rocketMQ.client.java.v5.MessageSendAsyncInterceptor";
        ...
        return new InstanceMethodsInterceptPoint[]{
                new InstanceMethodsInterceptPoint() {
                    ...
                    public ElementMatcher<MethodDescription> getMethodsMatcher() {
                        return named(ENHANCE_METHOD).and(takesArgumentWithType(0, "org.apache.rocketmq.client.apis.message.Message"));
                    }

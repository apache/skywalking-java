...
public class InterceptorTest {
    ...
    public void assertParse() {
        Object[] allArguments = new Object[]{"SELECT * FROM t_order"};
    ...
    public void assertRoute() {
        routeInterceptor.beforeMethod(null, null, new Object[]{}, null, null);
        routeInterceptor.afterMethod(null, null, new Object[]{}, null, null);
        assertThat(segmentStorage.getTraceSegments().size(), is(1));
        TraceSegment segment = segmentStorage.getTraceSegments().get(0);
        List<AbstractTracingSpan> spans = SegmentHelper.getSpans(segment);
        assertNotNull(spans);
    ...
    public void assertRewrite() {
        rewriteInterceptor.beforeMethod(null, null, new Object[]{}, null, null);
        rewriteInterceptor.afterMethod(null, null, new Object[]{}, null, null);
        assertThat(segmentStorage.getTraceSegments().size(), is(1));
        TraceSegment segment = segmentStorage.getTraceSegments().get(0);
        List<AbstractTracingSpan> spans = SegmentHelper.getSpans(segment);
        assertNotNull(spans);
    ...
    public void assertExecute() {
        executeInterceptor.beforeMethod(null, null, new Object[]{}, null, null);
        executeInterceptor.afterMethod(null, null, new Object[]{}, null, null);
        assertThat(segmentStorage.getTraceSegments().size(), is(1));
        TraceSegment segment = segmentStorage.getTraceSegments().get(0);
        List<AbstractTracingSpan> spans = SegmentHelper.getSpans(segment);
        assertNotNull(spans);

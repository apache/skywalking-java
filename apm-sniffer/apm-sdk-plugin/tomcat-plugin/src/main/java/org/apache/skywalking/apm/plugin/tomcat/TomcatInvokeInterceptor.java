...
public class TomcatInvokeInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public Object afterMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes,
        ...
        // The response status is read through the namespace-agnostic wrapper; it returns null when
        // getStatus() is unavailable (pre-Servlet-3.0), preserving the historical guard behavior.
        HttpResponseWrapper response = HttpResponseWrappers.wrap(allArguments[1]);
        if (response != null) {

...
public class AbstractTracingSpanHelper {
    ...
    public static List<LogDataEntity> getParentFieldLogs(AbstractTracingSpan tracingSpan) {
        try {
    ...
    public static List<LogDataEntity> get2LevelParentFieldLogs(AbstractTracingSpan tracingSpan) {
        try {

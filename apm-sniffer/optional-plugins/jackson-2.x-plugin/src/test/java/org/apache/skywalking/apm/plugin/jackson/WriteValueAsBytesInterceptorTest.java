...
public class WriteValueAsBytesInterceptorTest {
    ...
    public void testSendMessage() throws Throwable {
        ...
        Method method = ObjectWriter.class.getMethod("writeValueAsBytes", Object.class);

        writeValueAsBytesInterceptor.beforeMethod(null, method, arguments, null, null);
        writeValueAsBytesInterceptor.afterMethod(null, method, arguments, null, result);

...
`plugin.springmvc.generate_curl_command`| This config item controls that whether the SpringMVC plugin should generate curl command of the request, Which is useful for reproduce bug and debug | SW_PLUGIN_SPRINGMVC_GENERATE_CURL_COMMAND | `false`

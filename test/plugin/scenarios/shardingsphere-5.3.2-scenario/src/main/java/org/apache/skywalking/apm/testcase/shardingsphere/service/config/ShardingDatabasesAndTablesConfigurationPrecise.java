...
public final class ShardingDatabasesAndTablesConfigurationPrecise implements ExampleConfiguration {
    ...
    private void initDataSource() throws SQLException {
        ...
        shardingRuleConfig.getShardingAlgorithms().put("t_order_inline", new AlgorithmConfiguration("INLINE", tableOrderInlineProperties));
        ...
        shardingRuleConfig.getShardingAlgorithms().put("t_order_item_inline", new AlgorithmConfiguration("INLINE", tableOrderItemInlineProperties));
        shardingRuleConfig.getKeyGenerators().put("snowflake", new AlgorithmConfiguration("SNOWFLAKE", getProperties()));
    ...
    private AlgorithmConfiguration createDbShardingAlgorithmConfiguration() {
        Properties dbShardingAlgorithmrProps = new Properties();
        dbShardingAlgorithmrProps.setProperty("algorithm-expression", "demo_ds_${user_id % 2}");
        return new AlgorithmConfiguration("INLINE", dbShardingAlgorithmrProps);
    }
